...
(function( $ ) {
	...
	$.fn.ghostHunter.defaults = {
		...
		rss 				: "/rss",
		onKeyUp 			: false,
		result_template 	: "<div class=\"searchcontent\"><a href='{{link}}'><h2>{{title}}</h2><h4>{{pubDate}}</h4></a>,</div>",
		info_template		: "<div class=\"searchheader\"><p>Number of posts found: {{amount}}</p></div>",
